...
exports.MAKEUP_REMOVAL_PRODUCTS = void 0;
exports.seedMakeupRemovalProducts = seedMakeupRemovalProducts;
...
exports.MAKEUP_REMOVAL_PRODUCTS = MAKEUP_REMOVAL_PRODUCTS;
async function seedMakeupRemovalProducts() {
    try {
        const config = {
            ...
            entities: [product_entity_1.Product, recommendation_entity_1.Recommendation, quiz_entity_1.Quiz, user_entity_1.User],
            synchronize: false,
            logging: false,
        };
        ...
        await productRepository.delete({
            ...
            apiSourceId: (0, typeorm_1.Like)('manual_%')
        });
...
//# sourceMappingURL=makeup-remover-products.simple.seed.js.map